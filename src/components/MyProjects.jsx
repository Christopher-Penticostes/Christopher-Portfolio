    ...
    <div className='max-w-[1550px] mx-auto px-7 mb-[70px]'>
      ...
      <div className='grid grid-cols-3 gap-9 max-lg:grid-cols-2 max-md:grid-cols-1'>
        <div data-aos="fade-up" data-aos-duration="600">
          <img src={ordering} alt='Ordering System' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="800">
          <img src={wordpress} alt='WordPress-Based System' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="1000">
          <img src={foodOrdering} alt='Online Food Ordering System' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="1200">
          <img src={guidance} alt='Guidance and Counselling System' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="1400">
          <img src={weather} alt='Weather Temperature Data' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="1600">
          <img src={crud} alt='CRUD' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="1800">
          <img src={fibonacci} alt='Fibonacci Sequence' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="2000">
          <img src={prime} alt='Prime Number' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="2200">
          <img src={factorial} alt='Factorial Calculator' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="2400">
          <img src={calculator} alt='Calculator' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="2600">
          <img src={jackandpoy} alt='Jack and Poy' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
        ...
        <div data-aos="fade-up" data-aos-duration="2800">
          <img src={guessnumber} alt='Guessing Number' className='w-full object-contain shadow-md rounded-xl mb-[17px]'/>
